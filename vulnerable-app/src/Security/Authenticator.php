...
class Authenticator extends AbstractFormLoginAuthenticator
{
    ...
    {
        return 'app_comments_index' === $request->attributes->get('_route') && $request->isMethod('POST');
    }
    ...
    {
        return new RedirectResponse($this->router->generate('app_comments_index'));
    }

    protected function getLoginUrl(): string
    {
        return $this->router->generate('app_comments_index');
    }
}
